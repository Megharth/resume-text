...
Boston, MA\\
\hspace{1mm}
Masters in Computer Science \textbf{GPA: 3.83/4.0} \hfill Sep 2019 - Present\\
\hspace{1mm}
\textit{Relevant Coursework: Web Development, Scalable Distributed Systems, Algorithms} \hfill Expected Graduation: Dec 2021\\
\vspace{1mm}
\hspace{1mm}
...
\hspace{1mm}
\textit{Full stack intern} \hfill August 2020 - Jan 2021, May 2021 - Present\\
\vspace{-3mm}
\begin{itemize}
